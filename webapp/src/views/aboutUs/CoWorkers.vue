...
const educationalSupportCoworkers = computed(() => {
  return coworkerStore.coworkers.filter(coworker => coworker.type === CoWorkerType.EDUCATIONAL_SUPPORT);
});
...
<template>
  <div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-center mb-8 dark:text-white">Oktatást segítő munkatársak</h1>
    ...
    <div v-else-if="educationalSupportCoworkers.length === 0" class="text-center py-12">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <div
        v-for="coworker in educationalSupportCoworkers"
        :key="coworker._id"
